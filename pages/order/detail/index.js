...
Page({
    ...
    lookFn:function(e){
      wx.navigateTo({
        url: '../zenpin/index?id=' + this.data.options.id + '&status_type=1',
      })
    },
    lookFns:function(e){
     
      wx.navigateTo({
        url: '../zenpin/index?id=' + this.data.ismane.main_order.id + '&nid=' + this.data.ismane.main_order.openid + '&status_type=1',
      })
    },
    more: function() {
        this.setData({
